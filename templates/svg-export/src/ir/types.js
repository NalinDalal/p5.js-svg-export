    ...
    switch (cmd.type) {
        ...
        case 'rect': {
            ...
            if (radii && (radii.tl || radii.tr || radii.br || radii.bl)) {
                const r = radii.tl || 0;
                const d = `M ${num(x + r)} ${num(y)} h ${num(w - r * 2)} a ${num(r)} ${num(r)} 0 0 1 ${num(r)} ${num(r)} v ${num(h - r * 2)} a ${num(r)} ${num(r)} 0 0 1 ${num(-r)} ${num(r)} h ${num(-(w - r * 2))} a ${num(r)} ${num(r)} 0 0 1 ${num(-r)} ${num(-r)} v ${num(-(h - r * 2))} a ${num(r)} ${num(r)} 0 0 1 ${num(r)} ${num(-r)} z`;
